...
class TestNakedTwins(unittest.TestCase):
    ...
    before_naked_twins_3 = {
        'G7': '2345678', 'G6': '1236789', 'G5': "23456789", "G4": "345678", "G3": "1234569",
        "G2": "12345678", "G1": "23456789", "G9": "24578", "G8": "345678", "C9": "124578", 
        "C8": "3456789", "C3": "1234569", "C2": "1234568", "C1": "2345689", "C7": "2345678", 
        "C6": "236789", "C5": "23456789", "C4": "345678", "E5": "678", "E4": "2", "F1": "1", 
        "F2": "24", "F3": "24", "F4": "9", "F5": "37", "F6": "37", "F7": "58", "F8": "58", 
        "F9": "6", "B4": "345678", "B5": "23456789", "B6": "236789", "B7": "2345678", "B1": "2345689",
        "B2": "1234568", "B3": "1234569", "B8": "3456789", "B9": "124578", "I9": "9", "I8": "345678", 
        "I1": "2345678", "I3": "23456", "I2": "2345678", "I5": "2345678", "I4": "345678", "I7": "1", 
        "I6": "23678", "A1": "2345689", "A3": "7", "A2": "234568", "E9": "3", "A4": "34568", 
        "A7": "234568", "A6": "23689", "A9": "2458", "A8": "345689", "E7": "9", "E6": "4", "E1": "567",
         "E3": "56", "E2": "567", "E8": "1", "A5": "1", "H8": "345678", "H9": "24578", "H2": "12345678", 
         "H3": "1234569", "H1": "23456789", "H6": "1236789", "H7": "2345678", "H4": "345678", "H5": "23456789", 
         "D8": "2", "D9": "47", "D6": "5", "D7": "47", "D4": "1", "D5": "36", "D2": "9", 'D3': '8', 'D1': '36'}
    
    possible_solutions_3 = [
        {'G7': '2345678', 'G6': '1236789', 'G5': "23456789", "G4": "345678", "G3": "1234569", 
        "G2": "12345678", "G1": "23456789", "G9": "24578", "G8": "345678", "C9": "124578", "C8": "3456789", 
        "C3": "1234569", "C2": "1234568", "C1": "2345689", "C7": "2345678", "C6": "236789", "C5": "23456789", 
        "C4": "345678", "E5": "68", "E4": "2", "F1": "1", "F2": "24", "F3": "24", "F4": "9", "F5": "37", "F6": 
        "37", "F7": "58", "F8": "58", "F9": "6", "B4": "345678", "B5": "23456789", "B6": "236789", "B7": "2345678", 
        "B1": "2345689", "B2": "1234568", "B3": "1234569", "B8": "3456789", "B9": "124578", "I9": "9", "I8": "345678", 
        "I1": "2345678", "I3": "23456", "I2": "2345678", "I5": "2345678", "I4": "345678", "I7": "1", "I6": "23678", 
        "A1": "2345689", "A3": "7", "A2": "234568", "E9": "3", "A4": "34568", "A7": "234568", "A6": "23689", "A9": 
        "2458", "A8": "345689", "E7": "9", "E6": "4", "E1": "567", "E3": "56", "E2": "567", "E8": "1", "A5": "1", 
        "H8": "345678", "H9": "24578", "H2": "12345678", "H3": "1234569", "H1": "23456789", "H6": "1236789", 
        "H7": "2345678", "H4": "345678", "H5": "23456789", "D8": "2", "D9": "47", "D6": "5", "D7": "47", 
        "D4": "1", "D5": "6", "D2": "9", 'D3': '8', 'D1': '36'}]
...
class TestDiagonalSudoku(unittest.TestCase):
    ...
    solved_diag_sudoku = {'G7': '8', 'G6': '9', 'G5': '7', 'G4': '3', 'G3': '2', 'G2': '4', 'G1': '6', 'G9': '5',
                          ...
                          'D1': '5'}
    diagonal_grid2 = '5...4...3....87......653....71.3.4..4825.6391..6.9.27....324......81....1...6...9'
    solved_diag_sudoku2 = {'A1':'5','A2':'6','A3':'9','A4':'1','A5':'4','A6':'2','A7':'7','A8':'8','A9':'3', 
            'B1':'2','B2':'4','B3':'3','B4':'9','B5':'8','B6':'7','B7':'1','B8':'6','B9':'5', 
            'C1':'7','C2':'1','C3':'8','C4':'6','C5':'5','C6':'3','C7':'9','C8':'4','C9':'2', 
            'D1':'9','D2':'7','D3':'1','D4':'2','D5':'3','D6':'8','D7':'4','D8':'5','D9':'6', 
            'E1':'4','E2':'8','E3':'2','E4':'5','E5':'7','E6':'6','E7':'3','E8':'9','E9':'1', 
            'F1':'3','F2':'5','F3':'6','F4':'4','F5':'9','F6':'1','F7':'2','F8':'7','F9':'8', 
            'G1':'8','G2':'9','G3':'5','G4':'3','G5':'2','G6':'4','G7':'6','G8':'1','G9':'7', 
            'H1':'6','H2':'2','H3':'7','H4':'8','H5':'1','H6':'9','H7':'5','H8':'3','H9':'4', 
            'I1':'1','I2':'3','I3':'4','I4':'7','I5':'6','I6':'5','I7':'8','I8':'2','I9':'9'}                      

    def test_solve(self):
        self.assertEqual(solution.solve(self.diagonal_grid), self.solved_diag_sudoku)

    def test_solve_diagonal2(self):
